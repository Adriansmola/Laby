// Funkcja do pobierania danych pogodowych z OpenWeatherMap API, jeśli pobieramy dane z API to funkcja musi być asynchroniczna
...
function displayLocations() {
  ...
  locations.forEach((location, index) => {
    ...
    locationCard.innerHTML = `
          ...
          <p id="temp">Temperatura: ${Math.round(
        ...
        `;
    // dodajemy diva z danymi pogodowymi do kontenera z lokalizacjami
