// dodanie eventu po załadowaniu strony, więc cały kod wykona się dopiero po załadowaniu strony
document.addEventListener("DOMContentLoaded", () => {
  ...
  addNoteForm.addEventListener("submit", (event) => {
    // blokowanie domyślnej akcji formularza, czyli przeładowania strony
    ...
    displayNotes();
    // wyzerowanie formularza po dodaniu notatki czyli kliknięciu przycisku submit
    addNoteForm.reset();
  });
  ...
  // funkcja tworząca element notatki i zwracająca go przyjmuje notatkę i index notatki
  function createNoteElement(note, index) {
    ...
    // zwraca tagi jako string oddzielony przecinkami z tablicy tagów (interpolacja stringów)
    ...
    // dodanie elementów do głównego rodzica div.note jako dzieci tego diva
  ...
  function displayNotes() {
    ...
    notes.forEach((note, index) => {
      ...
      // dodanie stworzonej notatki do kontenera notatek
  ...
  function searchNotes() {
    ...
    // wyświetlanie tylko szukanej notatki/tek
    notesContainer.innerHTML = "";
